					...
					<section>
						<div class="box">
							...
							<hr>
								...
								<H2 class="align-center"><?php echo $this->lang->line('adminaccount');?></H2>
								<hr>
								<table data-role="table" data-mode="columntoggle" class="ui-responsive" id="myTable">
									<thead>
										...
										<th data-priority="4"><?php echo $this->lang->line('lastname');?></th>
										<th data-priority="4"><?php echo $this->lang->line('username');?></th>
										<th data-priority="4"><?php echo $this->lang->line('password');?></th>
										<th data-priority="4"><?php echo $this->lang->line('email');?></th>
                                   ...
                                   <?php }
                                    ?>
                                      ...
                                      <td> <a href="<?php echo base_url().'index.php/Caccount/edit_admin/'.$row->acc_id;?>" class="button special scrolly"><?php echo $this->lang->line('edit');?></a></td>
