				...
				<div class="inner">
					...
					<section>
						<div class="box">
							...
							<hr>
								<H2 class="align-center"><?php echo $this->lang->line('editaccount');?></H2>
								<hr>
								<form action="<?php echo base_url().'index.php/Caccount/edit_account/'.$account['acc_id'];?>" method="post">
                                
                                <div class="field half first">
								<input type="text" name="name" value="<?=$account['acc_name']?>">
									</div> 
                                <div class="field half">
								<input type="text" name="lastname" value="<?=$account['acc_lastname']?>">
                                </div> 
                                <div class="field half first">
								<input type="text" name="username" value="<?=$account['username']?>">
									</div> 
                                <div class="field half">
								<input type="email" name="email" value="<?=$account['acc_email']?>">
								</div> 
                                <div class="field half first">
                                ...
                                <a href="<?=base_url();?>index.php/Caccount/listaccount" class="button special scrolly"><?php echo $this->lang->line('cancel');?></a>	
