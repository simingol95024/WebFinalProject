				...
				<div class="inner">
					...
					<section>
						<div class="box">
							...
							<hr>
								<form action="<?php echo base_url().'index.php/Caccount/edit_account_admin/'.$admin['acc_id'];?>" method="post">
                                
                                <div class="field half first">
								<input type="text" name="name" value="<?=$admin['acc_name']?>">
									</div> 
                                <div class="field half">
								<input type="text" name="lastname" value="<?=$admin['acc_lastname']?>">
                                </div> 
                                <div class="field half first">
								<input type="text" name="username" value="<?=$admin['username']?>">
									</div> 
                                <div class="field half">
								<input type="email" name="email" value="<?=$admin['acc_email']?>">
								</div> 
                                <div class="field half first">
                                ...
                                <a href="<?=base_url();?>index.php/Caccount/admin" class="button special scrolly"><?php echo $this->lang->line('cancel');?></a>	
