		...
		<!--Create account -->
				...
				<div class="inner">
					...
					<section>
						<div class="box">
							<div class="content">
								<h2 class="align-center"><?php echo $this->lang->line('insertclass');?></h2>
								<hr />
								<form action="<?php echo base_url(),"index.php/Cclass/add_class"; ?>" method="post">
									<div class="field half first">
										<label for="name"><?php echo $this->lang->line('name');?></label>
										<input name="name" id="name" type="text" placeholder="<?php echo $this->lang->line('name');?>">
									</div> 
									<div class="field half">
									<label for="course"><?php echo $this->lang->line('coursename');?></label>
									<select name="course">
									<?php
								...
								<hr>
								<H2 class="align-center"><?php echo $this->lang->line('allclass');?></H2>
								<hr>
								<table data-role="table" data-mode="columntoggle" class="ui-responsive" id="myTable">
									<thead>
										<tr>
										<th data-priority="6"><?php echo $this->lang->line('id');?></th>
										<th data-priority="4"><?php echo $this->lang->line('name');?></th>
										<th data-priority="1"><?php echo $this->lang->line('coursename');?></th>
                                    ...
                                    <tr>
                                      ...
                                      <td>     <a href="<?php echo base_url().'index.php/Cclass/edit/'.$row->class_id;?>" ><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></td>
                                       <td>    <a href="<?php echo base_url().'index.php/Cclass/drop_class/'.$row->class_id;?>"><button data-toggle="tooltip" title="Delete" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a></td>
                                      </tr>  
                                   <?php }
                                    ?>
