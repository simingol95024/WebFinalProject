				...
				<div class="inner">
					...
					<section>
						<div class="box">
							...
							<hr>
								<H2 class="align-center"><?php echo $this->lang->line('editclass');?></H2>
								<hr>
								<form action="<?php echo base_url().'index.php/Cclass/edit_class/'.$class['class_id'];?>" method="post">
                                
                                <div class="field half first">
								<input type="text" name="name" value="<?=$class['class_name']?>">
									</div> 
                                <div class="field half first">
								<input type="text" name="course" value="<?=$class['c_id']?>">
								</div> 
								<input type="submit" value="<?php echo $this->lang->line('edit');?>" />
							
                                <a href="<?=base_url();?>index.php/Cclass/index" class="button special scrolly"><?php echo $this->lang->line('cancel');?></a>	
