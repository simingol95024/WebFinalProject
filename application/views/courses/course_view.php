		...
		<!--Create account -->
				...
				<div class="inner">
					...
					<section>
						<div class="box">
							<div class="content">
								<h2 class="align-center"><?php echo $this->lang->line('insert_course');?></h2>
								<hr />
								<form action="<?php echo base_url(),"index.php/Ccourse/add_course"; ?>" method="post">
									<div class="field half first">
										<input name="name" type="text" placeholder="<?php echo $this->lang->line('name');?>">
									</div>                                
								...
								<hr>
								<H2 class="align-center"><?php echo $this->lang->line('allcourse');?></H2>
								<hr>
								<table data-role="table" data-mode="columntoggle" class="ui-responsive" id="myTable">
                                    ...
                                    foreach($course as $row){?>
                                      ...
                                      <td> <?= $row->c_id; ?></td>
                                      <td> <?= $row->c_name; ?></td>
									  <td>    <a href="<?php echo base_url().'index.php/Ccourse/edit/'.$row->c_id;?>" ><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></td>
                                       <td>    <a href="<?php echo base_url().'index.php/Ccourse/drop_course/'.$row->c_id;?>"> <button data-toggle="tooltip" title="Delete" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a></td>
                                      </tr>  
                                   <?php }
                                    ?>
