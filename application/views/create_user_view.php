					...
					<section>
						<div class="box">
							<div class="content">
								...
								<hr />
								<form action="<?php echo base_url(),'index.php/Cprotection/createUser';?>" method="post">
                                ...
                                <h3 class="align-center"><?php echo $this->lang->line('grant');?></h3>
                                <form action="<?php echo base_url(),'index.php/Cprotection/setGrant';?>" method="post">
									<div class="field half first">
										<label for="name"><?php echo $this->lang->line('username');?></label>
										<input name="username" id="username" type="text" placeholder="<?php echo $this->lang->line('username');?>">
									</div>
									...
									<ul class="actions align-center">
                                    <li><input type="submit" value="<?php echo $this->lang->line('setgrant');?>"></li>
									</ul>
                                </form>
                                <hr>
                                <h3 class="align-center"><?php echo $this->lang->line('revock');?></h3>
                                <form action="<?php echo base_url(),'index.php/Cprotection/getGrant';?>" method="post">
									<div class="field half first">
										<label for="name"><?php echo $this->lang->line('username');?></label>
										<input name="username" id="username" type="text" placeholder="<?php echo $this->lang->line('username');?>">
									</div>
									...
									<ul class="actions align-center">
                                    <li><input type="submit" value="<?php echo $this->lang->line('getgrant');?>"></li>
									</ul>
                                </form>
							</div>
						</div>
