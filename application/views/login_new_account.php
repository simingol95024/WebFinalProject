					...
					<section>
						<div class="box">
							<div class="content">
								...
								<h2 class="align-center"><?php echo $this->lang->line('registeruser');?> </h2>
								<hr />
								<form action="<?php echo base_url(),"index.php/Caccount/new_account"; ?>" method="post">
									<div class="field half first">
										<label for="name"><?php echo $this->lang->line('name');?></label>
										<input name="name" id="name" type="text" placeholder="<?php echo $this->lang->line('name');?>" value="<?php echo set_value("name")?>">
									<?php echo form_error("name")?>
									</div>
									<div class="field half">
										<label for="lastname"><?php echo $this->lang->line('lastname');?></label>
										<input name="lastname" id="lastname" type="text" placeholder="<?php echo $this->lang->line('lastname');?>" value="<?php echo set_value("lastname")?>">
										<?php echo form_error("lastname")?>
									</div>
                                    <div class="field half first">
										<label for="username"><?php echo $this->lang->line('username');?></label>
										<input name="username" id="username" type="text" placeholder="<?php echo $this->lang->line('username');?>" value="<?php echo set_value("username")?>">
										<?php echo form_error("username")?>
									</div>
                                    <div class="field half ">
										<label for="email"><?php echo $this->lang->line('email');?></label>
										<input name="email" id="email" type="email" placeholder="<?php echo $this->lang->line('email');?>" value="<?php echo set_value("email")?>">
										<?php echo form_error("email")?>
									</div>
									<div class="field half">
										<label for="password"><?php echo $this->lang->line('password');?></label>
										<input name="password" id="password" type="password" placeholder="<?php echo $this->lang->line('password');?>" value="<?php echo set_value("password")?>">
										<?php echo form_error("password")?>
									</div><br>
									<input type="submit" value="<?php echo $this->lang->line('register');?>" />
                                    <a href="#login" class="button special scrolly"><?php echo $this->lang->line('login');?></a>
