				...
				<div class="inner">
					...
					<section>
						<div class="box">
							...
							<hr>
								<H2 class="align-center"><?php echo $this->lang->line('editteacher');?></H2>
								<hr>
								<form action="<?php echo base_url().'index.php/Cteacher/edit_teacher/'.$teacher['t_id'];?>" method="post">
                                
                                <div class="field half first">
								<label for="lastnamename"><?php echo $this->lang->line('name');?></label>
								<input type="text" name="name" value="<?=$teacher['t_name']?>">
									</div> 
                                <div class="field half">
								<label for="lastnamename"><?php echo $this->lang->line('lastname');?></label>
								
								<input type="text" name="lastname" value="<?=$teacher['t_lastname']?>">
                                </div> 
                                <div class="field half first">
								<label for="lastnamename"><?php echo $this->lang->line('email');?></label>
								<input type="text" name="email" value="<?=$teacher['t_email']?>">
									</div> 
                                <div class="field half">
								<label for="lastnamename"><?php echo $this->lang->line('phone');?></label>
								<input type="text" name="phone" value="<?=$teacher['t_phone']?>">
								</div> 
								<input type="submit" value="<?php echo $this->lang->line('edit');?>" />
					
                                <a href="<?=base_url();?>index.php/Cteacher/index" class="button special scrolly"><?php echo $this->lang->line('cancel');?></a>	
